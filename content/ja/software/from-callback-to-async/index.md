...
date: '2023-08-21'
draft: false
description: 順序的なフェードインアニメーションの実装を通して、JSにおける非同期処理を学びます。CallbackからPromiseへの移行、そしてAsync/Awaitを使ったより簡潔で読みやすいコードへのリファクタリングを解説します。
aliases:
  - /ja/software-development/from-callback-to-async/
  - /ja/tech/from-callback-to-async/
cover: "cover-ja.png"
---
