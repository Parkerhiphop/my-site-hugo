...
date: '2023-08-21'
description: 透過一個次序淡入動畫的需求來看 JS 中非同步操作的處理，如何從 Callback 結構轉換到 Promise ，再用 Async/Await 重構成更簡潔、好讀的程式碼。
aliases:
  - /software-development/from-callback-to-async/
  - /tech/from-callback-to-async/
